...
const TTS_CONFIG = {
  TIMEOUT_MS:        15_000,   // abort a single fetch after 15 s
  MAX_RETRIES:       3,        // attempts before giving up
  RETRY_BASE_MS:     800,      // first retry delay; doubles each attempt
  SLOW_NET_WARN_MS:  5_000,    // show "slow network" notice after this
  MAX_QUEUE_SIZE:    20,       // don't let the offline queue grow unbounded
